  ...
  render() {
    ...
    return (
      <section className='brand_slider_section'>
        ...
        <div className='brand-button-next'>
          {' '}
          <img
            src={require('../../assets/images/icons/chevron-right-solid.svg')}
            alt=''
          />{' '}
        </div>
        <div className='brand-button-preview'>
          {' '}
          <img
            src={require('../../assets/images/icons/chevron-left-solid.svg')}
            alt=''
          />{' '}
        </div>
      </section>
